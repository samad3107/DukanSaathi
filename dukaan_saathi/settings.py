"""
Django settings for dukaan_saathi project.
...
# Load a real project .env only. Do not silently treat .env.example as live runtime credentials.
...
SECRET_KEY = 'django-insecure-u@6%qy2jvt914tpf!jea&a_z(lpn@$ki9fe*%_3he2qzjd(3_9'
...
ROOT_URLCONF = 'dukaan_saathi.urls'
...
WSGI_APPLICATION = 'dukaan_saathi.wsgi.application'
